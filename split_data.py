...
def save_list(paths, fname, condition='negatives'):
    ...
    if condition == 'positives':
        for path in paths:
            ...
            out_file.write('{} 1 {} {} {} {}\n'.format(img_path, minx, miny, maxx - minx, maxy - miny))
...
save_list(pos_paths, pos_name, 'positives')
save_list(neg_paths, neg_name, 'negatives')
save_list(train_negs, neg_train, 'negatives')
save_list(train_pos, pos_train, 'positives')
save_list(val_negs, neg_val, 'negatives')
save_list(val_pos, pos_val, 'positives')
